package com.ldt.BeatHive.ui.widget.avsb;

import androidx.annotation.NonNull;
import androidx.annotation.WorkerThread;

import com.ldt.BeatHive.interactors.AppExecutors;
import com.ldt.BeatHive.interactors.MainThreadUtils;
...
class VisualSeekBarParser implements ProgressListener {
    ...
    protected com.ldt.BeatHive.ui.widget.soundfile.SoundFile mSoundFile;
    ...
    void parse(Song song) {
        AppExecutors.io().execute(() -> {
                    ...
                    try {
                        mSoundFile = com.ldt.BeatHive.ui.widget.soundfile.SoundFile.create(song, this);
                        //Thread.sleep(2500);
